...
- If you need to fill out a PDF form, follow the instructions in FORMS.md (create this file, per-project, if form-filling is needed and not yet documented)
- For troubleshooting, prefer `pypdf` first; fall back to `pdfplumber` for layout-sensitive extraction and `qpdf`/`pdftk` for CLI-based structural operations
